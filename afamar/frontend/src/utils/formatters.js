...
export const conceptosFabricacion = ['LONGITUD', 'ZÓCALO', 'FRENTE', 'TRAFORO DE PILETA', 'TRAFORO DE ANAFE', 'TRAFORO DE APOYO', 'OTRA']; // OTRA permite escribir concepto personalizado
