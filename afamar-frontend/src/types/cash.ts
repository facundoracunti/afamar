...
export interface CashMovement {
  ...
  /** Checkout URL generated by the gateway (Payway / Mercado Pago / etc.)
   *  for this payment. `null` for non-link-de-pago movements. Persisted on
   *  the backend row so reloads survive. */
