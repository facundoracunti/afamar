...
export default function ObservationsSection({ form, readOnly, update }: ObservationsSectionProps) {
  return (
    <div className="card" style={{ marginTop: 16, background: '#f9fafb', border: '1px solid #b91c1c' }}>
      ...
      <div className="form-group">
        ...
        <textarea className="input" rows={3} value={form.important_observations} onChange={(e) => update('important_observations', e.target.value)} placeholder="Agregar observaciones adicionales..." disabled={readOnly} />
      </div>
    </div>
  );
}
