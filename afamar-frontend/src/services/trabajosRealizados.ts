...
// The old endpoint was /trabajos-realizados. The new backend doesn't include
// this module yet. Keeping stubs so the import surface stays intact.
...
export const getTrabajosRealizados = getCompletedWorks;
export const getTrabajoRealizado = getCompletedWork;
export const createTrabajoRealizado = createCompletedWork;
export const updateTrabajoRealizado = updateCompletedWork;
export const deleteTrabajoRealizado = deleteCompletedWork;
export const uploadTrabajoFoto = uploadCompletedWorkPhoto;
