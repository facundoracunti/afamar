...
export default function PresupuestoForm() {
  ...
  const handleAprobar = async () => {
    ...
    try {
      const payload = buildPayload();
      const aprobado: PresupuestoPayload = { ...payload, estado: 'APROBADO' as const };
          ...
          <div ref={menuRef} style={{ position: 'relative' }}>
            ...
            {menuOpen && (
              <div className="dropdown-menu">
                ...
                <div className="dropdown-item" onClick={() => { setMenuOpen(false); window.open(getPresupuestoPdf(id as string), '_blank'); }}>
